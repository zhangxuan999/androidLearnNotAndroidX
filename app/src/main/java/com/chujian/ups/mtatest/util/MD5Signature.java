...
public class MD5Signature {
     ...
     * 生成签名，此过程建议在服务端调用
     */
    public static String doSign(int appID, String appSecret, String orderId, String productName, String productDes, String number, String amount, String uid, String timeStamp) {
        String sign = null;
        try {
            ...
            parameterMap.put("product_des", productDes);
            ...
            sign = MD5Signature.sign(verifyData, ":" + appID + ":" + appSecret);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return sign;
